    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lihatDataDiri.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent i = new Intent(getActivity(), LihatDataDiri.class);
                startActivity(i);
            }
        });
        ...
        ubahKataSandi.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getActivity(), UbahKataSandi.class);
                startActivity(i);
            }
        });
        ...
        pesananSaya.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getActivity(), PesananSaya.class);
                startActivity(i);
            }
        });
